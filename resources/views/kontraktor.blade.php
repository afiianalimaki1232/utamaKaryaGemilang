...
<!-- ======= Hero Section ======= -->
<section id="wallpaperKontraktor" class="d-flex align-items-center" style="background: url('{{ asset('web/assets/img/wallpaperk.jpg') }}') no-repeat center center/cover; position: relative; width: 100%; height: 100vh; opacity: 0.9">
    <div class="overlay"></div>
    <div class="container">
        <div class="title-box" data-aos="zoom-in" data-aos-delay="200">
          <h1>KONTRAKTOR</h1>
          <hr>
          <h3>KAMI MENYEDIAKAN LAYANAN KONSTRUKSI DENGAN MEMASTIKAN SETIAP PROYEK KONSTRUKSI DISELESAIKAN DENGAN KUALITAS DAN PROFESIONALISME TINGGI.</h3>
        </div>
    </div>
</section>
<!-- End Hero -->
  ...
  <section id="portfolio" class="portfolio">
    <div class="container" data-aos="fade-up">
      ...
      <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-{{ strtolower($bhn['category']) }}">
            ...
            <div class="portfolio-info">
                ...
                <a href="{{ asset('web/assets/img/kontraktor/' . $bhn['image']) }}" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="">
      ...
      <br>
      <center><h5>Renovasi bangunan permeter mulai dari Rp. 1.000.000 - Rp. 2.500.000, Menyesuaikan kerusakan bangunan</h5></center>
      <center><h5>Bangun baru permeter mulai dari Rp. 2.700.00 - Rp. 3.500.000, Menyesuaikan type dan Spesifikasi bangunan</h5></center>
    </div>
